...
{
	public class ReviewOneToManyRepository : MSSQLRepository<OneToMany<Review>>
	{
		private readonly IRepository<RegisteredUser> _registerUserRepository;

		public ReviewOneToManyRepository(string connectionString, IRepository<RegisteredUser> registerUserRepository)
		...
		public ReviewOneToManyRepository(string connectionString)
