...
{
	public class TicketOneToManyRepository : MSSQLRepository<Ticket>
	{
		...
		public TicketOneToManyRepository(string connectionString, Session session, IRepository<Employee> employeeRepository,
		...
		public TicketOneToManyRepository(string connectionString, Session session)
